    ...
    \[
        \boxed{
            \mathbf{x_2}(t) = \frac{-1}{5(7-\omega_2^2)}\left(\sin(\omega_2 t) - \frac{\omega_2}{\sqrt{7}}\sin(\sqrt{7})\right)\begin{bmatrix}
                1 \\ 2
            \end{bmatrix}
            - \frac{3}{5(2 - \omega_2^2)}\left(\sin(\omega_2 t) - \frac{\omega_2}{\sqrt{2}}\begin{bmatrix}
                2 \\ -1
            \end{bmatrix}\right)
        }
    \]
...
\begin{solution}
    ...
    \[
        \boxed{
            \mathbf{x_3}(t) = \frac{1}{5(7-\omega_2^2)}\left(\sin(\omega_2 t) - \frac{\omega_2}{\sqrt{7}}\sin(\sqrt{7})\right)\begin{bmatrix}
                1 \\ 2
            \end{bmatrix}
            - \frac{7}{5(2 - \omega_2^2)}\left(\sin(\omega_2 t) - \frac{\omega_2}{\sqrt{2}}\begin{bmatrix}
                2 \\ -1
            \end{bmatrix}\right)
        }
    \]
...
\begin{solution}
    ...
    \[
        \boxed{
            \mathbf{x}_4(t) = \frac{1}{5(7-\omega_1^2)}(\cos(\omega_1 t) - \cos(\sqrt{7}t))\begin{bmatrix}
                1 \\ 2
            \end{bmatrix} - \frac{2}{5(2-\omega_1^2)}(\cos(\omega_1 t) - \cos(\sqrt{2}t))\begin{bmatrix}
                2 \\ -1
            \end{bmatrix}
        } 
    \]
