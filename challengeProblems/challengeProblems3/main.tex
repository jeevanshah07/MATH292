...
\begin{equation}{\label{eq:1}}
    \mathbf{x}''(t) = -K\vec{x}(t) + \mathbf{f}(t), \quad \vec{x}(0) = (1, 2), \quad \mathbf{x}'(t) = (1, 1)
\end{equation}
and 
...
\begin{solution}
    \begin{proof}
        ...
        \begin{align*}
            ...
            &= (-K\mathbf{x}_0) + (-K\mathbf{x}_1 + \mathbf{f}_1) + (-K\mathbf{x}_2 + \mathbf{f}_2) +(-K\mathbf{x}_3 + \mathbf{f}_3) +(-K\mathbf{x}_4 + \mathbf{f}_4) \\
        ...
        so 
        \[
            \mathbf{x}''(t) = -K\mathbf{x}(t) + \mathbf{f}(t),
        \]
